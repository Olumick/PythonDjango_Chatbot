...
#             return render(request, 'speechtext.html', {'audio_text': audio_text})
#         except sr.UnknownValueError:
#             return render(request, 'speechtext.html', {'error_message': 'Could not understand the audio'})
#         except sr.RequestError:
#             return render(request, 'speechtext.html', {'error_message': 'Could not request results'})
#     return render(request, 'speechtext.html')

# ========================================================

# def members(request):
#   mymembers = chatbot.objects.all().values()
...
#   mymember = chatbot.objects.get(id=id)
